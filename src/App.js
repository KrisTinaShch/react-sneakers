    ...
    <div className="wrapper clear">
      ...
      <div className="content p-40">
        ...
        <div className="d-flex">
          <div className="card">
            <img src="/img/sneakers/1.jpg" alt="sneaker-image" width={133} height={112}></img>
          ...
          <div className="card">
            <img src="/img/sneakers/2.jpg" alt="sneaker-image" width={133} height={112}></img>
            <h5>Мужские Кроссовки Nike Blazer Mid Suede</h5>
            <div className="d-flex justify-between align-center">
              <div className="d-flex flex-column">
                <span>Цена: </span>
          ...
          <div className="card">
            <img src="/img/sneakers/3.jpg" alt="sneaker-image" width={133} height={112}></img>
            <h5>Мужские Кроссовки Nike Blazer Mid Suede</h5>
            <div className="d-flex justify-between align-center">
              <div className="d-flex flex-column">
                <span>Цена: </span>
          ...
          <div className="card">
            <img src="/img/sneakers/4.jpg" alt="sneaker-image" width={133} height={112}></img>
            <h5>Мужские Кроссовки Nike Blazer Mid Suede</h5>
            <div className="d-flex justify-between align-center">
              <div className="d-flex flex-column">
                <span>Цена: </span>
